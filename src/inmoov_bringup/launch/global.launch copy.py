...
def generate_launch_description():
    ...
    # Build configuration variables by passing the package share path each time.  We could do this in order to use
    # difference package share directory paths but requires extra processing
